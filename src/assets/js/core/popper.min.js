...
(function(e, t) {
    ...
    function E(e, t, o, i, n) {
        ...
        const d = Object.keys(s).map(function(e) {
            return se({
                key: e,
            }, s[e], {
                area: v(s[e]),
    ...
    function G(e, t, o, i) {
        ...
        const d = /\s*,\s*|\s+/;
        let a = -1 === s ? [p] : [p.slice(0, s).concat([p[s].split(d)[0]]), [p[s].split(d)[1]].concat(p.slice(s + 1))];
    ...
    let i; const te = J && Q(window.MutationObserver);
        ...
        modifiers: {
            ...
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    const o = w(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement);
                    ...
                    return p.forEach(function(s, d) {
                        ...
                        const l = V;
                        const m = 'left' === i && l(a.right) > l(f.left) || 'right' === i && l(a.left) < l(f.right) || 'top' === i && l(a.bottom) > l(f.top) || 'bottom' === i && l(a.top) < l(f.bottom);
                        const h = l(a.left) < l(o.left);
                        const c = l(a.right) > l(o.right);
                        const g = l(a.top) < l(o.top);
                        const u = l(a.bottom) > l(o.bottom);
                        const b = 'left' === i && h || 'right' === i && c || 'top' === i && g || 'bottom' === i && u;
                        const y = -1 !== ['top', 'bottom'].indexOf(i);
                        const w = !!t.flipVariations && (y && 'start' === r && h || y && 'end' === r && c || !y && 'start' === r && g || !y && 'end' === r && u);
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    let s; let d; const a = void 0 === p ? t.gpuAcceleration : p;
            ...
            applyStyle: {
                ...
                onLoad: function(e, t, o, i, n) {
                    const r = x(n, t, e);
                    const p = E(o.placement, r, t, e, o.modifiers.flip.boundariesElement, o.modifiers.flip.padding);
