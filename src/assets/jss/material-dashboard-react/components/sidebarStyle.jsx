...
const sidebarStyle = theme => ({
  ...
  black: {
    backgroundColor: primaryColor,
    boxShadow:
      "0 12px 20px -10px rgba(244,244,244,.28), 0 4px 20px 0 rgba(0,0,0,.12), 0 7px 8px -5px rgba(244,244,244,.2)",
    "&:hover": {
      backgroundColor: primaryColor,
      boxShadow:
        "0 12px 20px -10px rgba(200,200,200,.28), 0 4px 20px 0 rgba(0,0,0,.12), 0 7px 8px -5px rgba(200,200,200,.2)"
    }
  },
  sidebarWrapper: {
    position: "relative",
